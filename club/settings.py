...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "Тэта Бизнес Клуб <club@vas3k.club>")

# App

APP_HOST = os.getenv("APP_HOST", "https://127.0.0.1:8000")
APP_NAME = "Тэта Бизнес Клуб"
